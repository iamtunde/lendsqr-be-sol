        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // Deletes all existing records
                    _a.sent();
                    return [4 /*yield*/, knex("wallets").del()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, knex("transactionLimits").del()];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, Promise.all(users_json_1.default.map(function (user) { return __awaiter(_this, void 0, void 0, function () {
                            var hashedPassword;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, hash_1.encrypt)(user.password)];
                                    case 1:
                ...
                case 4:
                    users = _a.sent();
                    return [4 /*yield*/, knex("users").insert(users).select("id")];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, knex("users")
                            .whereIn("email", users.map(function (user) { return user.email; }))
                            .select(["id", "phone"])];
                case 6:
                    entries = _a.sent();
